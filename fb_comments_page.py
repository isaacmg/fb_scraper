...
def getFacebookCommentFeedData(status_id, access_token, num_comments, tStamp):
...
def scrapeFacebookPageFeedComments(file_id, access_token, tstamp):
    with open('data/files/' +tstamp +'/%s_facebook_comments.csv' % file_id, 'w', newline='', encoding='utf-8') as file:
        w = csv.writer(file)
        ...
        with open('data/files/' + tstamp +  '/%s_facebook_statuses.csv' % file_id, 'r', encoding='utf-8') as csvfile:
